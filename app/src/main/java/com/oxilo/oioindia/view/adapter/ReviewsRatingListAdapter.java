 ...
 */
public class ReviewsRatingListAdapter extends DataBoundListAdapter<BusinessListing, BusRowItemBinding> {
    private final DataBindingComponent dataBindingComponent;
    private final RepoClickCallback repoClickCallback;

    public ReviewsRatingListAdapter(DataBindingComponent dataBindingComponent,
    ...
    protected BusRowItemBinding createBinding(ViewGroup parent) {
        BusRowItemBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()), R.layout.reviews_row,
