 ...
 */
public class CategoryListAdapter extends DataBoundListAdapter<Category, CategoryItemBinding> {
    private final DataBindingComponent dataBindingComponent;
    private final RepoClickCallback repoClickCallback;
    private final boolean showFullName;

    public CategoryListAdapter(DataBindingComponent dataBindingComponent, boolean showFullName,
